...
| `bind.cpp`: solvers / `encode.cpp`: MB + split-K + fp16 staging | — | missing — the MB fire path after the M=1 smoke; split-K and fp16 staging deferred with the shared family's |
| device smoke vs Qwen3.6-35B-A3B | — | missing — next |
