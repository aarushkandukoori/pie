...
| `decode_consts.cpp` / `bind.cpp` / device smoke | — | missing — the consts walk (per-layer strides, softcap, PLE params, `norm_plus_one=false`), the step, the smoke vs the cached gemma-4 checkpoints |
