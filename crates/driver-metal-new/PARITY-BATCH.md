...
| the MB device step + paged smoke; split-K; fp16 staging; tiled paged sdpa | — | missing/deferred — the assembly after the portable half; the deferred rungs with the shared family's |
